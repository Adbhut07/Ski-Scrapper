...
export const reviews: Review[] = [
  { id: 1, name: "Priya Sharma", location: "New Delhi", rating: 5, text: "Booked my Goa trip through Soami Travels and got amazing prices! The WhatsApp booking was so convenient. Highly recommend!", route: "DEL → GOI", date: "2026-02-15" },
  ...
  { id: 5, name: "Sneha Patel", location: "Ahmedabad", rating: 5, text: "I was skeptical about booking via WhatsApp but Soami Travels made it so smooth! Tickets confirmed in just 5 minutes.", route: "AMD → DEL", date: "2026-02-11" },
  ...
  { id: 10, name: "Amit Joshi", location: "Pune", rating: 5, text: "I travel frequently for business and Soami Travels always gets me the best business class deals. My go-to agent now!", route: "PNQ → DEL", date: "2026-02-06" },
  ...
  { id: 13, name: "Neha Saxena", location: "Kolkata", rating: 5, text: "My parents needed to travel urgently and Soami Travels arranged everything within 30 minutes. Incredibly helpful!", route: "CCU → BOM", date: "2026-02-03" },
  ...
  { id: 20, name: "Rajesh Iyer", location: "Thiruvananthapuram", rating: 5, text: "Excellent service! Been using Soami Travels for 6 months now. Every booking has been smooth and well-priced.", route: "TRV → BOM", date: "2026-01-27" },
  ...
  { id: 27, name: "Pallavi Jain", location: "Udaipur", rating: 5, text: "I always get the best Udaipur to Delhi deals from Soami Travels. Never disappointed with the service!", route: "UDR → DEL", date: "2026-01-20" },
  ...
  { id: 30, name: "Pankaj Dubey", location: "Gorakhpur", rating: 5, text: "My family flies 3-4 times a year and we always use Soami Travels. Consistent great service and savings!", route: "GOP → DEL", date: "2026-01-17" },
  ...
  { id: 34, name: "Vivek Chauhan", location: "Shimla", rating: 4, text: "Reliable and trustworthy. I've recommended Soami Travels to all my friends and family.", route: "SLV → BOM", date: "2026-01-13" },
  ...
  { id: 38, name: "Abhishek Yadav", location: "Allahabad", rating: 5, text: "Tried many travel agents before. Soami Travels is by far the best in terms of price and service quality.", route: "IXD → BOM", date: "2026-01-09" },
  ...
  { id: 46, name: "Kunal Mehra", location: "Noida", rating: 5, text: "Living in Noida, I fly frequently to Bangalore for work. Soami Travels consistently saves me ₹1,500-₹3,000 per trip!", route: "DEL → BLR", date: "2026-01-01" },
  ...
  { id: 48, name: "Tarun Gupta", location: "Ghaziabad", rating: 5, text: "My entire office uses Soami Travels now. Started with me, and everyone loves the service. Quality speaks for itself!", route: "DEL → MAA", date: "2025-12-30" },
  ...
  { id: 57, name: "Kamla Devi", location: "Jodhpur", rating: 5, text: "I'm 65 years old and not good with apps. Soami Travels on WhatsApp is perfect for me. Just message and everything is done!", route: "JDH → BOM", date: "2025-12-21" },
  ...
  { id: 59, name: "Vanshika Arora", location: "Faridabad", rating: 5, text: "Booked an emergency flight for my brother's wedding. Got an amazing last-minute deal. Thank you Soami Travels!", route: "DEL → CCU", date: "2025-12-19" },
  ...
  { id: 62, name: "Dhruv Kapoor", location: "Mohali", rating: 5, text: "Tech professional here — I've compared their prices algorithmically. Soami Travels beats major platforms 8 out of 10 times!", route: "IXC → BLR", date: "2025-12-16" },
  ...
  { id: 68, name: "Alok Verma", location: "Lucknow", rating: 5, text: "I run a small business and send employees on trips regularly. Soami Travels has saved me lakhs over the year!", route: "LKO → DEL", date: "2025-12-10" },
  ...
  { id: 70, name: "Mahesh Gupta", location: "Delhi", rating: 5, text: "I live in Delhi and fly 2-3 times a month. Soami Travels is my permanent travel partner. Unbeatable prices!", route: "DEL → BOM", date: "2025-12-08" },
  ...
  { id: 75, name: "Saumya Das", location: "Jorhat", rating: 5, text: "From a small town in Assam, finding affordable flights was always a challenge. Not anymore, thanks to Soami Travels!", route: "JRH → DEL", date: "2025-12-03" },
  ...
  { id: 79, name: "Archana Mishra", location: "Varanasi", rating: 5, text: "Booked 20+ flights this year through Soami Travels. Consistent quality, great prices, and wonderful people!", route: "VNS → BOM", date: "2025-11-29" },
  ...
  { id: 81, name: "Meenakshi Iyer", location: "Coimbatore", rating: 5, text: "My son studies in Delhi and I book his flights every month. Soami Travels always finds the cheapest option!", route: "CJB → DEL", date: "2025-11-27" },
  { id: 82, name: "Pawan Kumar", location: "Dehradun", rating: 5, text: "Trustworthy service. I've referred 15 people and they all thank me for introducing them to Soami Travels!", route: "DED → BOM", date: "2025-11-26" },
  ...
  { id: 87, name: "Anjali Bhargava", location: "Bhopal", rating: 5, text: "Professional, punctual, and perfectly priced. The three P's of Soami Travels. Highly recommended!", route: "BHO → BOM", date: "2025-11-21" },
  ...
  { id: 94, name: "Deepak Joshi", location: "Dehradun", rating: 5, text: "Booked my first flight ever through Soami Travels. They patiently walked me through everything. So grateful!", route: "DED → BLR", date: "2025-11-14" },
  { id: 95, name: "Mitali Roy", location: "Agartala", rating: 4, text: "From the remote Northeast, finding good flight deals was tough. Soami Travels changed that completely!", route: "IXA → DEL", date: "2025-11-13" },
  ...
  { id: 100, name: "Yash Raj", location: "Mumbai", rating: 5, text: "I've been with Soami Travels since day one. They've grown but the personal service remains the same. Genuine people!", route: "BOM → DEL", date: "2025-11-08" },
];
